	...
	<div class="r">
		...
		<form id="jvForm" action="/shopping/login.shtml" method="post">
			...
			<li><label for="captcha">验证码：</label>
				...
				<img src="/shopping/getCodeImage.shtml" onclick="this.src='/shopping/getCodeImage.shtml?d='+new Date()" class="code" alt="换一张" /><a href="javascript:void(0);" onclick="$('.code').attr('src','/shopping/getCodeImage.shtml?d='+new Date())" title="换一张">换一张</a></li>
